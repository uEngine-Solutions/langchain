...
public abstract class AbstractExtensionFunction implements ExtensionFunction{
    ...
    public MutableParameter[] getMutableParameters(){
        return (MutableParameter[]) mutableParams.toArray(emptyMutables);
    }
    ...
    public Parameter[] getParameters(){
        return (Parameter[]) parameters.toArray(emptyParams);
    }
    ...
    private java.util.List mutableParams = new java.util.ArrayList( );
