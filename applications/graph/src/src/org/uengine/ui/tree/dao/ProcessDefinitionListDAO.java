...
public class ProcessDefinitionListDAO {
     ...
     */
    @SuppressWarnings("unchecked")
	public List<Item> selectProcessDefinitions(final String endpoint, final String comCode, final String parentDefId, final char cPermission, final String procType) {
        StringBuffer sql = new StringBuffer();
        sql.append("SELECT  DEF.defid                 ").append("\n")
           ...
           .append("   AND  DEF.PROCTYPE = ?      ").append("\n");
        
        final AclManager aclManager = AclManager.getInstance(transactionContext);
        
            return this.jdbcTemplate.query(sql.toString(), new Object[]{comCode, new Long(parentDefId), procType}, new RowMapper() {
            public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
                Item item = null;
     ...
     */
    @SuppressWarnings("unchecked")
    public List<Item> selectAllProcessDefinitions(final String parentDefId, final String procType) {
    	StringBuffer sql = new StringBuffer();
    	...
    	return this.jdbcTemplate.query(sql.toString(), new Object[]{new Long(parentDefId), procType}, new RowMapper() {
    		public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
    			Item item = null;
