...
//			strHtml.append("<textarea class=\"ckeditor\" id=\"").append(Util.quote(name)).append("\" ")
			...
			.append("		try { ").append("\n")
//			.append("			if (CKEDITOR.instances['").append(Util.quote(name)).append("']) { ").append("\n")
//			.append("				CKEDITOR.instances['").append(Util.quote(name)).append("'].destroy(); ").append("\n")
//			.append("			} ").append("\n")
			.append("			CKEDITOR.replace('").append(Util.quote(name)).append("', { ").append("\n")
			.append("				toolbar : 'General' ").append("\n")
			.append("			}); ").append("\n")
			.append("		} catch(e) {").append("\n")
//			.append("			alert(e); ").append("\n")
			.append("		}").append("\n")
			.append("</script>");
            out.print(strHtml);
