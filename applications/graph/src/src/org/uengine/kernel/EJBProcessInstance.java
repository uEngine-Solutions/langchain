...
////////////// private methods ////////////////////
	...
	public String getMainProcessInstanceId() {
		try {
			Long mainInstId = getProcessInstanceDAO().getMainInstId();
			String mainProcessInstanceIdInStr = mainInstId != null ? String.valueOf(mainInstId) : null;
	...
	public String getRootProcessInstanceId() {
		try {
			Long rootInstId = getProcessInstanceDAO().getRootInstId();
			return rootInstId != null ? String.valueOf(rootInstId) : null;
		} catch (Exception e) {
			return null;
		}
	}
