...
public class SwimlaneViewer implements GraphActivityViewer {
	...
	private StringBuilder getRoleInformationCell(Role role, ProcessInstance instance) {
		...
		sb.append(
				...
				+ "</tr><tr>"
					...
					+ "<tr height='45'><td align='center' width='35'><img src='" + GlobalContext.WEB_CONTEXT_ROOT + "/images/portrait/" + sEp + ".gif' width='35' height='45' onerror='setUnkwonImage(this);' />" 
	...
	private boolean isFirstSwitchActivity(Activity activity, Activity childActivity) {
		...
		if (activity == childActivity) {
			...
			Vector<Activity> childrenOfActivity = ((ComplexActivity) childActivity).getChildActivities();
